...
<xsl:output method="xml" />
    <dp:summary xmlns="">
        ...
        <description>Symantec Virus Scanning</description>
        <descriptionId>store.antivirus-symantec.dpsummary.description</descriptionId>
    </dp:summary>
    ...
    <xsl:template name="icap-test">
        ...
        <xsl:variable name="httpHeaders">
            ...
            <header name="Encapsulated"><xsl:value-of select="concat('req-hdr=0,res-hdr=56,res-body=103',$eol,$eol,'GET http://scapi.symantec.com/eicar.rar.msg HTTP/1.0',$eol,$eol,'HTTP/1.0 200 OK',$eol,'Transfer-Encoding: chunked')" /></header>
        </xsl:variable>

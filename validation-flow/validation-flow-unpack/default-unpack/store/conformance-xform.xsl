...
<!--  <xsl:include href="store:///dp/conformance-common-temp.xsl"/> -->

  <dp:summary xmlns="">
      <operation>xform</operation>
      <suboperation>Conformance-transform</suboperation>
      <description>Profile Conformance transform</description>
      <descriptionId>store.conformance-xform.dpsummary.description</descriptionId>
  </dp:summary>

  <dp:param name="dpconfig:conformance-policy" type="dmReference" reftype="ConformancePolicy" xmlns="" subtype="ConformancePolicyXForm">
    <display>Conformance Policy</display>
    <displayId>store.conformance-xform.param.conformance-policy.display</displayId>
    <description>Policy specifying what conformance checks are to be made    
    </description>
    <descriptionId>store.conformance-xform.param.conformance-policy.description</descriptionId>
  </dp:param>
  ...
  <dp:param name="dpconfig:validate-soap-schema" type="dmToggle" xmlns="">
    ...
    <displayId>store.conformance-xform.param.validate-soap-schema.display</displayId>
    <description>    
    ...
    <descriptionId>store.conformance-xform.param.validate-soap-schema.description</descriptionId>
    <default>off</default>
  </dp:param>
  ...
  <xsl:template match="/">
    ...
    <xsl:apply-templates select="/" mode="check-conformance">
      <xsl:with-param name="mode" select="'xform'"/>
    </xsl:apply-templates>
